...
# print(len(data[data['trip_type'].isna()]))
print(data[data['trip_type'] == 'business trip'])
print(data['trv_type'])
...
# data.drop(["Hotel_Address", "Negative_Review", "Review_Total_Negative_Word_Counts", "Total_Number_of_Reviews",
# "Positive_Review", "Review_Total_Positive_Word_Counts", "Total_Number_of_Reviews_Reviewer_Has_Given"], axis=1,
# inplace=True)

# print(len(data['Hotel_City'].unique()))

# print(len(data['Hotel_Address']), len(data[data['Hotel_Address'].isnull()]))
