...
class CsvModelTester:
    def __init__(self, master):
        ...
        self.select_file_button = tk.Button(master, text="Select File", command=self.select_file, bg="#0072C6",
        ...
        self.test_button = tk.Button(master, text="Test Model", command=self.test_model, bg="#0072C6", fg="white",
                                     font=("Arial", 12))
